...
; <label>:10                                      ; preds = %.lr.ph
  ...
  %14 = load float* %13, align 4, !tbaa !8
  %15 = add nsw i64 0, %6
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %0
  ...
  store float %tmp.0.lcssa, float* %42, align 4, !tbaa !8
  ret void
}
