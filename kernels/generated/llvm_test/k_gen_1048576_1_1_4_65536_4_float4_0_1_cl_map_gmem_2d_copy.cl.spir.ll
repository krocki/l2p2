...
define spir_kernel void @k_gen_1048576_1_1_4_65536_4_float4_0_1_cl_map_gmem_2d_copy(<4 x float> addrspace(1)* noalias nocapture, <4 x float> addrspace(1)* noalias nocapture readonly) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !7 !kernel_arg_type_qual !8 {
  %3 = tail call spir_func i32 @_Z13get_global_idj(i32 1) #2
  %4 = tail call spir_func i32 @_Z15get_global_sizej(i32 0) #2
  %5 = mul i32 %4, %3
  %6 = tail call spir_func i32 @_Z13get_global_idj(i32 0) #2
  %7 = add i32 %5, %6
  %8 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %1, i32 %7
  %9 = load <4 x float>, <4 x float> addrspace(1)* %8, align 16, !tbaa !9
  %10 = getelementptr inbounds <4 x float>, <4 x float> addrspace(1)* %0, i32 %7
  store <4 x float> %9, <4 x float> addrspace(1)* %10, align 16, !tbaa !9
  ret void
}
