; ModuleID = 'k_gen_2160_36_10_360_2160_6_float_cl_copy_gmem.cl'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind uwtable
define void @k_gen_2160_36_10_360_2160_6_float_cl_copy_gmem(float* noalias nocapture %out, float* noalias nocapture readonly %in) #0 {
  %1 = tail call i32 (i32, ...) bitcast (i32 (...)* @get_global_id to i32 (i32, ...)*)(i32 0) #2
  %2 = icmp slt i32 %1, 2160
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %indvars.iv.next = add nsw i64 %indvars.iv, 360
  %9 = icmp slt i64 %indvars.iv.next, 2160
...
!0 = !{void (float*, float*)* @k_gen_2160_36_10_360_2160_6_float_cl_copy_gmem, !1, !2, !3, !4, !5}
