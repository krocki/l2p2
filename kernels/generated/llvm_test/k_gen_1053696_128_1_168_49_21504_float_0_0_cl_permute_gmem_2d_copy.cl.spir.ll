...
define spir_kernel void @k_gen_1053696_128_1_168_49_21504_float_0_0_cl_permute_gmem_2d_copy(float addrspace(1)* noalias nocapture, i32 addrspace(1)* noalias nocapture readonly, float addrspace(1)* noalias nocapture readonly) local_unnamed_addr #0 !kernel_arg_addr_space !4 !kernel_arg_access_qual !5 !kernel_arg_type !6 !kernel_arg_base_type !6 !kernel_arg_type_qual !7 {
  ...
  %5 = tail call spir_func i32 @_Z15get_global_sizej(i32 1) #2
  %6 = mul i32 %5, %4
  %7 = tail call spir_func i32 @_Z13get_global_idj(i32 1) #2
  %8 = add i32 %6, %7
  %9 = getelementptr inbounds i32, i32 addrspace(1)* %1, i32 %8
  %10 = load i32, i32 addrspace(1)* %9, align 4, !tbaa !8
  %11 = getelementptr inbounds float, float addrspace(1)* %2, i32 %10
  %12 = load float, float addrspace(1)* %11, align 4, !tbaa !12
  %13 = getelementptr inbounds float, float addrspace(1)* %0, i32 %8
  store float %12, float addrspace(1)* %13, align 4, !tbaa !12
  %14 = getelementptr inbounds float, float addrspace(1)* %2, i32 %8
  %15 = load float, float addrspace(1)* %14, align 4, !tbaa !12
  %16 = getelementptr inbounds float, float addrspace(1)* %0, i32 %10
