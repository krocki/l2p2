...
* @Last Modified time: 2017-05-21 22:02:06
*/
...
std::string exec_cl_gemm (cl_array<float>& C, cl_array<float>& A, cl_array<float>& B, std::string kernel_op, size_t lsize_x, size_t lsize_y, size_t ngroups_x, size_t ngroups_y, size_t vecn = 1, bool profiling_enabled = false) {
	...
	assert(is_multiple(C.device_data_size, global_work_size_xy * vecn));
